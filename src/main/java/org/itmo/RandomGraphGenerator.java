...
public class RandomGraphGenerator {
  ...
  Graph generateGraph(Random r, int size, int numEdges) {
    return generateGraph(r, size, numEdges, Runtime.getRuntime().availableProcessors());
  }


  Graph generateGraph(Random r, int size, int numEdges, int P) {
